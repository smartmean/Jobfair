    ...
    return(
        ...
        <section className='form'>
            <form onSubmit={onSubmit}>
                ...
                placeholder='Confirm Your password2 'required/>
                </div>

                <div className='form-group'>
                <input type='role' className='form-control' id='role' name='role' value={role} onChange={onChange}
                placeholder='Confirm Your role 'required/>
                </div>
